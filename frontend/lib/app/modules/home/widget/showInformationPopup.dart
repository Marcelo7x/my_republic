...
class ShowInformationPopup extends StatefulWidget {
  const ShowInformationPopup({Key? key}) : super(key: key);

  @override
  State<ShowInformationPopup> createState() => _ShowInformationPopupState();
}

class _ShowInformationPopupState
    extends ModularState<ShowInformationPopup, HomeStore> {
  @override
